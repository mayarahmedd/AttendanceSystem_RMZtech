...
class AttendanceController extends BaseController
{
    ...
    public function index(){
        ...
        $attendances = Attendance::with(['course', 'teacher'])->WhereCourse(request()->get('course_filter'))->WhereDateIs(request()->get('date_filter'))->withCount('students')->get();
        $courses = Course::all();
        return view('Manage.pages.Attendance.index', compact('attendances', 'courses'));
    }
    ...
    public function store(StoreAttendanceRequest $request){
        ...
        return view('Manage.pages.Attendance.take-attendance', compact('attendance', 'course'));
    }
    ...
    public function edit(Attendance $attendance){
        ...
        $attendance->load('students', 'course');
